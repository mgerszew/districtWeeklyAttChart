...
│   ├── admin-student-page-template.html      # Full Admin Portal student page template
│   ├── form-field-templates.html             # Common form field snippets
│   ├── tlist-sql-template.html               # tlist_sql embed template
...
- **PSHTML files use `.html` extension** (standard PowerSchool convention)
