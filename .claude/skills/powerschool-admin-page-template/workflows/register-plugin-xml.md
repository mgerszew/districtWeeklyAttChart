...
<page>
    <name>page_name</name>
    <path>/admin/students/page_name.html</path>
...
| Field | Value | Notes |
|-------|-------|-------|
| `<name>` | `page_name` | Must match .html filename (without extension) |
| `<path>` | `/admin/students/page_name.html` | Full path from web root |
...
- [ ] `<name>` matches .html filename
- [ ] `<path>` correct: `/admin/students/[name].html`
